...
from text_housekeep.habitat_lab.habitat.tasks.eqa import _try_register_eqa_task
from text_housekeep.habitat_lab.habitat.tasks.nav import _try_register_nav_task
from text_housekeep.habitat_lab.habitat.tasks.vln import _try_register_vln_task
