...
from text_housekeep.habitat_lab.habitat.core.dataset import Dataset, Episode, EpisodeIterator
from text_housekeep.habitat_lab.habitat.core.embodied_task import EmbodiedTask, Metrics
from text_housekeep.habitat_lab.habitat.core.simulator import Observations, Simulator
...
from text_housekeep.habitat_lab.habitat.tasks import make_task
from text_housekeep.habitat_lab.habitat.utils import profiling_wrapper
from text_housekeep.cos_eor.explore.sim import ExploreSim
from text_housekeep.cos_eor.explore import sensors
...
class Env:
    ...
    def __init__(
        ...
        if self._dataset:
            ...
            self._config.SIMULATOR.SCENE = self._config.SIMULATOR.SCENE.split('data')[0] + self._dataset.episodes[0].scene_id
            self._config.freeze()
    ...
    def reset(self) -> Observations:
        ...
        if self._current_episode is None:
            for _ in range(self._config['EPISODE_NUM'] + 1):
