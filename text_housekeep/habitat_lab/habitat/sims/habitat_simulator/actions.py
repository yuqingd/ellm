...
from text_housekeep.habitat_lab.habitat.core.simulator import ActionSpaceConfiguration
    ...
    def get(self):
        ...
        new_config = {
            HabitatSimActions.LOOK_UP: habitat_sim.ActionSpec(
                "look_up",
                habitat_sim.ActuationSpec(amount=self.config.TILT_ANGLE, constraint=self.config.TILT_CONSTRAINT),
            ),
